        ...
        xhr.send = function (body) {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState === 4) { // Complete
                    ...
                    let postData = null;
                    if (requestDetails.method.toUpperCase() !== 'GET' && (requestDetails.headers['Content-Type'] || requestDetails.body)) {
                       postData = { mimeType: requestDetails.headers['Content-Type'] || null, text: requestDetails.body }; 
                    }
